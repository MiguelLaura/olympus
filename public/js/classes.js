var titleControlClass = L.Control.extend({
  ...
  onAdd: function () {
    ...
    div.innerHTML =
      '<h1>Sites des compétitions<br aria-hidden="true"><br aria-hidden="true">J.O. Paris 2024</h1>';
    return div;
  },
});
...
var legendControlClass = L.Control.extend({
  ...
  onAdd: function () {
    ...
    div.innerHTML +=
      '<i style="background: #2981ca"></i> Jeux olympiques<br aria-hidden="true">';
    div.innerHTML +=
      '<i style="background: #c81c2e"></i> Jeux paralympiques<br aria-hidden="true">';
    return div;
  },
});
  ...
  filter(
    ...
    geojsonLayer = L.geoJSON(geojsonFeatures, {
      filter: function (feature) {
        ...
        // Filter event
        if (
          feature.properties.category == "venue-olympic" &&
          !inputOlympicsChecked
        ) {
          return false;
        } else if (
          feature.properties.category == "venue-paralympic" &&
          !inputParalympicsChecked
        ) {
          return false;
        }
        ...
        // Filter sport
        if (
          !(selectSportsValue == "Tout") &&
          !feature.properties.sports.includes(selectSportsValue)
        ) {
          return false;
        }
        return true;
